...
export MAIN_PLATFORMS='declare -A main_platforms=( [uno]="arduino:avr:uno" [esp8266]="esp8266:esp8266:huzzah:eesz=4M3M,xtal=160" [esp32]="esp32:esp32:featheresp32:FlashFreq=80")'
...
#export IO_PLATFORMS='declare -A io_platforms=( [esp8266]="esp8266:esp8266:huzzah:eesz=4M3M,xtal=160" [esp32]="esp32:esp32:featheresp32:FlashFreq=80" )'
...
DEPENDENCY_OUTPUT=$(arduino --pref "boardsmanager.additional.urls=http://arduino.esp8266.com/stable/package_esp8266com_index.json,https://dl.espressif.com/dl/package_esp32_index.json" --save-prefs 2>&1)
if [ $? -ne 0 ]; then echo -e """$RED""\xe2\x9c\x96"; else echo -e """$GREEN""\xe2\x9c\x93"; fi
