/*
	...
	The standard Pixie text functions (write, push, shift)
	...
	pix.push(B00001100, B00010010, B00100100, B00010010, B00001100);
	or
	pix.push(0x0C,0x12,0x24,0x12,0x0C); for short.
	...
	instead i.e. "pix.push(PIX_HEART);"
...
void loop() {
  ...
  pix.shift(0x5D,0x55,0x55,0x55,0x77); // Custom icon (columns) generated by https://connornishijima.github.io/Pixie/extras/icon_generator.html
  pix.show();
}